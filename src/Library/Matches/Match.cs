namespace Matches
{
    ...
    */
    ...
    public class Match : IMatch
    {
        ...
        public Match(Gameboard user1Gameboard, Gameboard user2Gameboard, User user1)
    {
        this.User1Gameboard = user1Gameboard;
        this.User2Gameboard = user2Gameboard;
        this.User1 = user1;

        Random rand = new Random();
        this.MatchID = rand.Next(100000, 999999);
        this.User2 = null;
